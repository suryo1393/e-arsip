...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'databerkas' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'jenisberkas' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'kantor_wilayah' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'kantor_cabang' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'nama_teknisi' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'user' => array('list','view','accountedit','accountview','add','edit', 'editfield','delete','import_data','userregister'),
							'data_request_barang' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'databarang' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'project_mesin' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'status_barang' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
		
			'user' =>
						array(
							'databerkas' => array('list','view','add','edit', 'editfield','import_data'),
							'kantor_cabang' => array('list','view','add','edit', 'editfield'),
							'user' => array('userregister'),
							'data_request_barang' => array('list','view','add','edit', 'editfield'),
							'databarang' => array('list','view','add','edit', 'editfield')
						)
		);
