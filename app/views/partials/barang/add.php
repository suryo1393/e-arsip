                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_type_barang"  value="<?php  echo $this->set_field_value('id_type_barang',""); ?>" type="text" placeholder="Enter Id Type Barang"  required="" name="id_type_barang"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-Lokasi_barang"  value="<?php  echo $this->set_field_value('Lokasi_barang',""); ?>" type="text" placeholder="Enter Lokasi Barang"  required="" name="Lokasi_barang"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Kondisi_barang"  value="<?php  echo $this->set_field_value('Kondisi_barang',""); ?>" type="text" placeholder="Enter Kondisi Barang"  required="" name="Kondisi_barang"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="input-group">
                                                                            <input id="ctrl-tanggal_input" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tanggal_input',""); ?>" type="datetime" name="tanggal_input" placeholder="Enter Tanggal Input" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
