                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_type_barang">
                                        <th class="title"> Id Type Barang: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-merek_barang">
                                        <th class="title"> Merek Barang: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Lokasi_barang">
                                        <th class="title"> Lokasi Barang: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-Kondisi_barang">
                                        <th class="title"> Kondisi Barang: </th>
                                        <td class="value">
